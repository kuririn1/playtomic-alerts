...
export async function getPlaytomicTournaments(): Promise<Tournaments> {
  const url = 'https://api.playtomic.io/v2/tournaments?available_places=true&coordinate=53.013790199999995,18.5984437&enable_price_calculation=true&page=0&radius=50000&registration_status=OPEN&size=10&sort=start_date,created_at,ASC&sport_id=PADEL&status=PENDING&visibility=PUBLIC';
